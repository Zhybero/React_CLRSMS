...
function ClientInformationModalHearing(props) {
                  ...
                  <div className="row">
                    <div className="col-12">
                      ...
                      <button
                        ...
                        data-bs-target="#ReplyNewMessageModal"
                        className="btn btn-sm text-white"
                        style={{ background: "#303030" }}
                      >
                        <i className="fa-solid fa-square-plus me-1"></i>New
                        Message
                      </button>
                    </div>
                  </div>
                      ...
                      ? props.varvarlist.map((varlist, index) => (
                          <div className="col-12 mx-auto mb-3" key={index}>
                            <div className="container p-3 mx-auto rounded text-start bg-white border-3 border-top border-warning">
                              ...
                              {varlist.hDate?varlist.hDate>new Date().toISOString()?(
                              ...
                              <div className="container-fluid mt-2 d-flex gap-2">
                                ...
                                <button
                                  ...
                                  style={{ background: "#3EAA94" }} 
                                  onClick={()=>props.varbtnDecline(varlist)}
                                >
                                  <i className="fa-solid fa-paperclip"></i> Evidence
                                </button>
                                ...
                                <button
                                  ...
                                  onClick={()=>props.varbtnFinish(varlist)}
                                >
                                  Finish
                                </button>
                                ...
                                <button
                                  ...
                                  className="btn text-white"
                                  data-bs-toggle="modal"
                                  data-bs-target="#UpdateAppointmentActive"
                                  style={{ background: "#4E7C00" }} 
                                  onClick={()=>props.varbtnrow(varlist)}
                                >
                                  Schedule
                                </button>
...
export default ClientInformationModalHearing;
