...
function ClearData() {
  ...
  async function btnSend(){ 
      // setvalid(0);
      try {
        // if (!props.varparamvarViewMailobjCredential.email || props.varparamvarViewMailobjCredential.email.trim() === "") {
        //   setvalid(1);
        ...
        // } else {
          ...
          const Mdl1 = {
              ToUserEmail: props.varparamvarViewMailobjCredential.email,
                  ...
                  <div className="form-floating col-lg-6 col-sm-12 mb-3  text-start">
                    <div className="input-group">
                      ...
                      <input
                        ...
                        readOnly 
                        value={props.varparamvarViewMailobjCredential.email}
                      /> 
                    </div>
                  </div>
