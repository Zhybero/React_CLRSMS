...
async function btnDelete(varcontent){ 
  const Mdl1 = {  
    ...
    if (response.status === 200) {
      ...
      props.varfetchMdlVieIBNameList(props.varuserSession.userCode); 
    } else {
      ...
      <>
        <div className="modal-content">
          ...
          <div className="modal-footer">
            ...
            {props.varuserSession.groupCode !== "04" ? (
              <button
                type="button"
                className="btn text-white"
                data-bs-toggle="modal"
                data-bs-target="#ArchiveModal"
                style={{ background: "#054C5A" }}
              >
                Archive
              </button>
            ) : (
            ...
            <button
              ...
              className="btn text-white"
              data-bs-toggle="modal"
              data-bs-target="#ReplyMessageModalCred"
