...
function ViewMailNotificationModal(props){
      ...
      <>
        <div className="modal-content">
          <div className="modal-header">
            ...
            <small className="ms-2">@{props.varparamvarViewMailobjCredential.email}</small>
            <button
              type="button"
              className="btn-close"
                ...
                <div className="row p-2">
                  <div className="col-8 bg-white rounded">
                    <div className="ps-2">
                      <p className="mt-2">
                        {" "}
                        <b className="fs-5 me-2">Subject : </b> {props.varparamvarViewMailobj.subject}
                      </p>
                    </div>
                  </div>
...
export default ViewMailNotificationModal;